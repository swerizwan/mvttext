import inspect
import os
from jointsrotsfeats.rotation2xyz import Rotation2xyz
import numpy as np
import torch
...
from core.losses.motiontext import MotionTextLosses
from core.modeltype.base import BaseModel
from utils.temos_utils import remove_padding

from .base import BaseModel


class MOTIONTEXT(BaseModel):
    """
    Stage 1 vae
    Stage 2 diffusion
    """
    ...
    def __init__(self, cfg, datamodule, **kwargs):
        ...
        if cfg.LOSS.TYPE == "mld":
            self._losses = MetricCollection({
                split: MotionTextLosses(vae=self.is_vae, mode="xyz", cfg=cfg)
